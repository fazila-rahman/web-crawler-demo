        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <svg viewBox="0 0 251 72" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">
                    ...
                    <svg height="45" width="300" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">    
                        <text x="0" y="35" fill="red" font-size="2em">Web Crawler Demo </text>
                    </svg>
                </div>
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">    
                        <div class="flex items-center container-lg">
                            <div class="ml-4 text-lg leading-7 font-semibold container-md">
                                ...
                                <form action="{{url('spider')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="url" id="url">
                                            <option value="https://agencyanalytics.com">https://agencyanalytics.com</option>
                                            <option value="https://www.google.com/">https://www.google.com/</option>
                                            <option value="https://www.php.net/">https://www.php.net/</option>
                                            <option value="https://laravel.com/">https://laravel.com/</option>
                            
                                        </select>    
                                    </div>
                                    <div class="form-group">
                                        <label>Set # of Pages: </label>
                                    ...
                                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                        ...
                                        <input type="submit" name="send" value="Click to Crawl" class="btn btn-secondary">    
                                        </div>
                                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        @isset($page_status_codes)
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                                <div class="ml-4 text-lg leading-7 font-semibold">Crawled Pages</div>
                            </div>
                                ...
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <table class="table table-striped table-inverse table-responsive">    
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($page_status_codes as $page)
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Created using Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
            </div>                        
        </div>
